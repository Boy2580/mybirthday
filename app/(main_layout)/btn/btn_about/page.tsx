    ...
    return (
        <div>
            <Link
                ...
                className="bg-[#000000] py-5 px-3 w-40 border rounded-full flex items-center justify-between text-sm leading-none h-14 hover:scale-98 about-link"
            >
                ...
                <div className="bg-[#FB9E3A] w-10 h-10 rounded-full flex justify-center items-center">
                    <img src="/image/rr.svg" alt="Go to about page" className="w-7 wiggle-hover" />
                </div>
            </Link>
        </div>
    )
